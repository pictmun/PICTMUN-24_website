...
const Page: React.FC = () => {
  ...
  return (
    <div className='bg-darkblue  min-h-screen overflow-x-hidden'>
      <h1 className="text-center pb-10 pt-20 text-white text-4xl lg:text-5xl relative font-bold">
        About the Club
      </h1>
     
      <div>
        <div className="md:w-5/6 w-[90%] relative mx-auto h-[455px] md:mx-0 ">
          <img
          ...
          >
            <span className="lg:pl-20 p-10 lg:pr-20 text-justify text-darkblue text-base md:text-lg leading-5">
      ...
      <div className="flex justify-end py-5 mt-20">
        <div className="md:w-5/6 w-[90%] relative h-[455px] mx-auto md:mx-0">
          <img
          ...
          >
            <span className=" p-10 lg:px-20 text-darkblue text-justify text-base md:text-lg leading-5">
