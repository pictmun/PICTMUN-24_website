...
<<<<<<< HEAD
      <div className="grid grid-cols-1  md:grid-cols-2 gap-20 pb-11 align-baseline">
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
=======
      <div className="grid grid-cols-2 gap-5 md:gap-20 pb-11 align-baseline">
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      </div>
      <div className="grid grid-cols-3 gap-5 md:gap-16">
>>>>>>> 047de1e417697eb307d4999fff41508187ba420d
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      </div>
...
=======
      ...
      <h2 className="  text-4xl text-white  relative  py-20 ">Under Secretary General</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-36 pb-11 align-baseline">
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
      <TeamMember  name={'Anshika Singh'} designation={"USG Design"} image={"/images/Anshika_Singh.jpg"}/>
